                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      required
                      className="block w-full pl-10 pr-3 py-2 border-0 border-b-2 border-secondary text-primary placeholder-primary/50 bg-transparent focus:ring-0 focus:border-primary-light transition-colors"
